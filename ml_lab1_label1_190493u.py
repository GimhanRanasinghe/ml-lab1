# -*- coding: utf-8 -*-
"""ML-lab1-label1-190493U.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kZgx4DNFtvbvbO_p4-kiFJkwy28lObA2
"""
...
"""Fill the null values in the features with their means in the train, valid and test datasets & Extract the first label"""
...
"""Identify the features that are highly correlated with the label using the traning dataset & Extract the features that are only highly correlated with the label from all datasets"""
...
destination = '/content/drive/MyDrive/Colab Notebooks/ML/Lab 1/190493U_label_1.csv'
